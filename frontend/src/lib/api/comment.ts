...
export const createComment = async (placeId: string, data: CommentCreateRequest): Promise<CommentResponse> => {
  const response = await api.post(`/places/${placeId}/comments`, data);
